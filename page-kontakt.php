                        ...
                        <div class="contact-item">
                            <div class="contact-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M22 16.92V19.92C22 20.4696 21.5523 20.9173 21.0027 20.9201C18.1566 20.9481 15.3541 20.1196 12.9406 18.5262C10.7271 17.0861 8.91476 15.0546 7.67831 12.6448C6.10002 10.2305 5.27231 7.42771 5.30031 4.56832C5.30299 4.0187 5.75077 3.57092 6.30031 3.57092H9.30031C9.82526 3.57092 10.2582 3.97804 10.2931 4.49986C10.3595 5.51504 10.5562 6.5176 10.8781 7.48192C11.0259 7.92449 10.8757 8.41237 10.5031 8.70992L9.20031 9.71992C10.3753 11.9089 12.0913 13.6249 14.2803 14.7999L15.2903 13.4971C15.5879 13.1245 16.0758 12.9744 16.5183 13.1221C17.4827 13.4441 18.4852 13.6407 19.5004 13.7071C20.0234 13.7421 20.4303 14.1761 20.4303 14.7011L22 16.92Z" fill="currentColor"/>
                                </svg>
                            </div>
                        ...
                        <div class="social-links">
                            <a href="https://www.facebook.com/KMpersonal" target="_blank" class="social-link" aria-label="Facebook">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047v-2.66c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.971h-1.514c-1.491 0-1.955.93-1.955 1.886v2.264h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"/>
                                </svg>
                            </a>
                        </div>
                    </div>
